          ...
          <div class="row gy-5">
            @if (isset($CollectionsProducts))
              ...
              <div class="col-lg-4 menu-item text-center align-items-center mt-2 mb-2">
                ...
                <a data-id="{{$item['reference']}}" class="btn btn-primary text-white">
                  Adicionar
...
<a href="{{route("plataform.service.get.cart", ["company" => $data->companyhashtoken])}}" style="color: #fff;background: #F4C400;" class="cartcout d-flex align-items-center justify-content-center">      
